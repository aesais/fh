...
@FhService
public class AuditLogService extends GenericFacadeService<String, AuditLogDto, AuditLogDto, AuditLogDtoQuery> implements IAuditLogDtoService {
